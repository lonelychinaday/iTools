      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            />
            <div className="flex gap-2">
              <Button onClick={copyToClipboard} disabled={!output} variant="outline" className="flex-1">
                {copied ? <Check className="h-4 w-4 mr-2" /> : <Copy className="h-4 w-4 mr-2" />}
                {copied ? "已复制" : "复制"}
              </Button>
              <Button onClick={downloadJson} disabled={!output} variant="outline" className="flex-1">
